...
write_rds(resale_data, "data/rds/resale_data.rds")
resale_data <- read_rds("data/rds/resale_data.rds")
```
...
```{r}
write_rds(resale_data2, "data/rds/resale_data2.rds")
resale_data2 <- read_rds("data/rds/resale_data2.rds")
```
...
Apartment_monthly_avg <- resale_data2 %>%
...
Condo_monthly_avg <- resale_data2 %>%
...
ExecCondo_monthly_avg <- resale_data2 %>%
...
Others_monthly_avg <- resale_data2 %>%
